...
function updateViewGraph(viewGraph, dataGraph, showCompleted) {
  console.log('start');
  ...
  // if (!showCompleted) {
  //   for (const [id, node] of viewGraph.nodes.entries()) {
  //     if (node.completed) {
  //       viewGraph.removeNodeAndContract(id);
  //     }
  //   }
  // }
  console.log('end');
...
const App = () => {
  ...
  createEffect(() => {
    ...
    console.log('view');
    updateViewGraph(viewGraph, dataGraph, showCompleted());
    console.log('convert');
